...
var Animal = /*#__PURE__*/function () {
  function Animal() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3___default()(this, Animal);

    this.name = '动物';
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(Animal, [{
    key: "say",
    value: function say() {
      console.log('say');
    }
...
var Tiger = /*#__PURE__*/function (_Animal) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_0___default()(Tiger, _Animal);

  var _super = _createSuper(Tiger);

  function Tiger() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_3___default()(this, Tiger);
